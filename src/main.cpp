...
int main(int argc, char *argv[]) {
    try {
        ...
        std::string device = config.getString("device");
        std::string model_xml = config.getString("config");
        ...
        std::string binFileName = fileNameNoExt(model_xml) + ".bin";
        ...
        /** Read network model **/
        CNNNetwork network = ie.ReadNetwork(model_xml);
        // -----------------------------------------------------------------------------------------------------
        ...
        ExecutableNetwork executable_network = ie.LoadNetwork(network, device, configure(FLAGS_config));
        // -----------------------------------------------------------------------------------------------------
        ...
        SPDLOG_INFO("took {}, {}", time_taken/std::chrono::milliseconds(1), "ms to run");
        return 0;
